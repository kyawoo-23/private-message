...
import './Login.css'
import catPic from '../../icons/cat.png'
  ...
  return (
    <div className='login'>
      <div style={{margin: 'auto'}}>
        <img style={{width: '280px'}} src={catPic} alt='cat-illustration' />
      </div>
      <button onClick={googleSignIn} className={`google-btn ${mode}`} disabled={isLoading}>
